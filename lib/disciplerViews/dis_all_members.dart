...
class DisAllMembersPage extends StatefulWidget {
  final String token;
  const DisAllMembersPage({super.key, required this.token});

  @override
  State<DisAllMembersPage> createState() => _DisAllMembersPageState();
}

class _DisAllMembersPageState extends State<DisAllMembersPage> {
                          ...
                          child: Padding(
                            ...
                            child: Card(
                              ...
                              child: ListTile(
                                ...
                                leading: InkWell(
                                  onTap: () => showFullImageDialog(imageURL),
                                  child: CircleAvatar(
